...
def eval_joint_force(
    ...
    target_f = target_ke * pos_err + target_kd * vel_err
    ...
    if type == JointType.PRISMATIC:
        ...
        f_total = axis_p * (
            ...
            - eval_joint_force(
                q,
                qd,
                joint_pos_target[qd_start],
                joint_vel_target[qd_start],
        ...
        if lin_axis_count >= 1:
            ...
            f_total += axis_0 * (
                ...
                - eval_joint_force(
                    q0,
                    qd0,
                    joint_pos_target[qd_start + 0],
                    joint_vel_target[qd_start + 0],
        ...
        if lin_axis_count >= 2:
            ...
            f_total += axis_1 * (
                ...
                - eval_joint_force(
                    q1,
                    qd1,
                    joint_pos_target[qd_start + 1],
                    joint_vel_target[qd_start + 1],
        ...
        if lin_axis_count == 3:
            ...
            f_total += axis_2 * (
                ...
                - eval_joint_force(
                    q2,
                    qd2,
                    joint_pos_target[qd_start + 2],
                    joint_vel_target[qd_start + 2],
        ...
        if ang_axis_count == 1:
            ...
            t_total = axis_p * (
                ...
                - eval_joint_force(
                    q,
                    qd,
                    joint_pos_target[i_0],
                    joint_vel_target[i_0],
                    joint_target_ke[i_0],
                    joint_target_kd[i_0],
        ...
        if ang_axis_count == 2:
            ...
            t_total += axis_1 * (
                ...
                - eval_joint_force(
                    angles[1],
                    wp.dot(axis_1, w_err),
                    joint_pos_target[i_1],
                    joint_vel_target[i_1],
                    joint_target_ke[i_1],
                    joint_target_kd[i_1],
        ...
        if ang_axis_count == 3:
            ...
            t_total += axis_2 * (
                ...
                - eval_joint_force(
                    angles[2],
                    wp.dot(axis_2, w_err),
                    joint_pos_target[i_2],
                    joint_vel_target[i_2],
                    joint_target_ke[i_2],
                    joint_target_kd[i_2],
