...
class Model:
    ...
    def __init__(self, device: Devicelike | None = None):
        ...
        self.shape_active_variant = None
        """Active mesh variant index per shape (0 = default mesh), shape [shape_count], int32.

        Use with :data:`~newton.solvers.SolverNotifyFlags.MESH_VARIANT_PROPERTIES`
        to apply variant-specific geometry and body properties at runtime.
        """
